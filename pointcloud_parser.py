...
from utils import record_run_time, show_run_time
import numpy as np
import dpkt
...
def parse(buf, lidar):
    ...
    # z = pc[:, 2]
    # s = pc[:, 3]
    # l = mlab.points3d(x, y, z, s, mode='point', colormap='cool',
                      # scale_factor=10.5)
...
def test():
    ...
    with open('data/2015-07-23-14-37-22_'
              'Velodyne-VLP-16-Data_Downtown 10Hz Single.pcap', 'rb') as f:
